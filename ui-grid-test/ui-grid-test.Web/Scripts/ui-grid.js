  ...
  var uiGridColumnMenu = {
    ...
    link: function ($scope, $elm, $attrs, uiGridCtrl) {
      ...
      $scope.hideColumn = function () {
        ...
        $scope.grid.api.core.raise.columnChanged();
      };
    },
  ...
  var service = {
    ...
    registerPublicApi: function (grid) {
        ...
        var publicApi = {
            events: {
                 ...
                 */
                hideColumn: {
                    hideColumnChanged: function (colDef, deltaChange) {
    ...
    toggleColumnVisibility: function( gridCol ) {
      ...
      gridCol.grid.refresh();
        //  $scope.$emit('ngGridEventSorted');
      gridCol.grid.api.core.raise.columnChanged();
    }
  };
    ...
    function ($scope, $elm, $attrs, gridUtil, $q, uiGridConstants,
      ...
      function dataWatchFunction(newData) {
        ...
        if (newData) {
          ...
          self.grid.api.core.raise.showColumn(self.grid);
...
//                }
              ...
              {
                //  alert(grid.options.gridId);
                  if (grid.rows != null && grid.rows.length > 0 &&grid.options!=null&& grid.options.data!=null&& grid.options.data.length>0) {
                      if (grid.Nr == undefined) {
                          grid.Nr = 0;
                      }
                      else {
                          grid.Nr ++;
                      }
                      //  alert("a" + grid.rows.length);
                      if (grid.Nr == 0) {
                          grid.api.core.raise.renderScrollBarComplete();
                      }
                  }
                  else if (grid.Finish == true) {
                      grid.Finish = false;
                      grid.api.core.raise.renderScrollBarComplete();
                  }
                  
                 
                  grid.hasRightContainer();
...
angular.module('ui.grid')
.factory('Grid', ['$q', '$rootScope', '$compile', '$parse', 'gridUtil', 'uiGridConstants', 'GridOptions', 'GridColumn', 'GridRow', 'GridApi', 'rowSorter', 'rowSearcher', 'GridRenderContainer', '$timeout',
    function ( $q,$rootScope, $compile, $parse, gridUtil, uiGridConstants, GridOptions, GridColumn, GridRow, GridApi, rowSorter, rowSearcher, GridRenderContainer, $timeout) {
        ...
        var Grid = function Grid(options) {
            ...
            this.api.core.on.columnChanged($rootScope, function (rootScope) {
 ...
 */
   ...
   */
  var columnDefsKey = 'columnDefsKey12';
  ...
  //this.api.core.on.columnChanged(function () {
  //    alert("aaaaa");
  //});
    ...
    .factory('GridApi', ['$q', '$rootScope', 'gridUtil', 'uiGridConstants', 'GridRow', 'uiGridGridMenuService',
      function ($q, $rootScope, gridUtil, uiGridConstants, GridRow, uiGridGridMenuService) {
        ...
        var GridApi = function GridApi(grid) {
          ...
          this.registerEvent('core', 'columnChanged');

          this.registerEvent('core', 'showColumn');

          this.registerEvent('core', 'renderScrollBarComplete');
...
.factory('GridOptions', ['gridUtil','uiGridConstants', function(gridUtil,uiGridConstants) {
  ...
  return {
    initialize: function( baseOptions ){
      ...
      //  alert("aa" + baseOptions.enableGridMenu);
        baseOptions.enableGridMenu = baseOptions.enableGridMenu == undefined ? true : baseOptions.enableGridMenu;
        baseOptions.enableFiltering = baseOptions.enableFiltering == undefined ? true : baseOptions.enableFiltering;
        baseOptions.enableColumnResizing = baseOptions.enableColumnResizing == undefined ? true : baseOptions.enableColumnResizing;
      /**
       * @ngdoc object
       * @name data
       * @propertyOf ui.grid.class:GridOptions
    ...
    function (gridUtil, uiGridConstants, uiGridCellNavConstants, $q, UiGridCellNav) {
      ...
      var service = {
        ...
        cellNavColumnBuilder: function (colDef, col, gridOptions) {
           ...
           *  <br/>Defaults to true
           */
          colDef.allowCellFocus = colDef.allowCellFocus === undefined ? false : colDef.allowCellFocus;
      ...
      var service = {
        ...
        fireColumnSizeChanged: function (grid, colDef, deltaChange) {
            ...
            $timeout(function () {
                ...
                grid.api.core.raise.columnChanged();
...
angular.module('ui.grid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui-grid/ui-grid',
    "<div ui-i18n=\"en\" class=\"ui-grid grid\"><!-- TODO (c0bra): add \"scoped\" attr here, eventually? --><style ui-grid-style>.grid{{ grid.id }} {\n" +
    "      /* Styles for the grid */\n" +
    "    }\n" +
    "\n" +
